...
import { getARAgingReport } from "@/lib/actions/report.action";
    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between">
        <Heading
          ...
          description="Customer outstanding balances by age"
        />
      ...
      <div className="rounded-lg border bg-emerald-50 p-4">
        <div className="flex justify-between items-center">
          <span className="text-lg font-bold">Total Accounts Receivable</span>
          <span className="text-2xl font-bold text-emerald-600">GHS {totals.total.toLocaleString()}</span>
        </div>
      </div>
    </div>
  );
