...
import VendorLoginForm from "./_components/vendor-login-form";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <p className="text-center text-muted-foreground">Vendor Portal</p>
        </CardHeader>
        <CardContent>
          <VendorLoginForm organizationId={organizationId} />
        </CardContent>
      </Card>
    </div>
  );
