  ...
  const navMain: (NavItem | false)[] = [
    ...
    organization?.modules?.products && {
      ...
      items: [
        ...
        {
          title: "Warehouses",
          url: `/${organizationId}/dashboard/${userId}/products/warehouses`,
          icon: Warehouse,
          roleField: "warehouses_view",
          isNew: true,
        },
        {
          title: "Stock Transfer",
          url: `/${organizationId}/dashboard/${userId}/products/transfers`,
          icon: ArrowLeftRight,
          roleField: "stockTransfers_view",
          isNew: true,
        },
        {
        ...
        {
          title: "Batch & Expiry",
          url: `/${organizationId}/dashboard/${userId}/products/batch-expiry`,
          icon: Calendar,
          roleField: "batchExpiry_view",
          isPro: true,
        },
      ],
    },
